...
func tableIPInfoIP(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "asn", Type: proto.ColumnType_JSON, Transform: transform.FromField("ASN"), Description: "Autonomous System Number (ASN) of the administrator for the IP, e.g. AS13335"},
			...
			{Name: "is_eu", Type: proto.ColumnType_BOOL, Transform: transform.FromField("IsEU"), Description: "True if the IP address is located in the European Union (EU)."},
